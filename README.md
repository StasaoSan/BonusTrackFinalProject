...
Скрипт заполнения таблиц данными, сгенерированными программой, написанной мной (ее описание можно посмотреть [тут]([#скрипт-для-генерации-sql-запросов-заполнения-таблиц](https://github.com/StasaoSan/BonusTrackFinalProject/blob/main/createImportL.ipynb))), итоговвый результат можно найти в файле `insert.sql`.
